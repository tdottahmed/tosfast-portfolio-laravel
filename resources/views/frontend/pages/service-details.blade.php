    ...
    <section class="banner__inner-page bg-image pt-180 pb-180 bg-image"
        ...
        <div class="container">
            ...
            <div class="breadcrumb-list wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <a href="/">Home</a><span><i class="fa-regular fa-angles-right mx-2"></i>Service
                    Details</span>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-8 order-2 order-lg-1">
                    <div class="service-single__left-item">
                        <div class="image mb-50">
                            <img src="{{ asset('assets/frontend/images/service/service-single-image1.jpg') }}"
                                alt="image">
                        ...
                        <h3 class="title mb-30">{{ $service->title }}</h3>
                        ...
                        <div class="item sub-bg mb-30">
                            ...
                            <ul class="category service-category">
                                @foreach ($services as $service)
                                    <li><a
                                            href="{{ route('frontend.serviceSingle', $service->id) }}">{{ $service->title }}</a>
