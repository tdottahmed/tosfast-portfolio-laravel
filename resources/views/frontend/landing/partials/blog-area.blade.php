<section class="blog-area pt-120 pb-120">
    <div class="container">
        <div class="section-header text-center mb-60">
            ...
            <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Explore Blogs and
                News
            </h2>
        </div>
        <div class="row g-4">
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                <div class="blog__item">
                    <a href="blog-details.html" class="blog__image d-block image">
                        <img src="assets/frontend/images/blog/blog-image1.jpg" alt="image">
                        <div class="blog-tag">
                    ...
                    <div class="blog__content">
                        ...
                        <h3><a href="blog-details.html" class="primary-hover">Necessity May Give us Best
                                Virtual
                                Court</a></h3>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="blog__item">
                    <a href="blog-details.html" class="blog__image image d-block">
                        <img src="assets/frontend/images/blog/blog-image2.jpg" alt="image">
                        <div class="blog-tag">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                <div class="blog__item">
                    <a href="blog-details.html" class="blog__image image d-block">
                        <img src="assets/frontend/images/blog/blog-image3.jpg" alt="image">
                        <div class="blog-tag">
                    ...
                    <div class="blog__content">
                        ...
                        <h3><a href="blog-details.html" class="primary-hover">Easy and Most Powerful Server
                                and
                                Platform</a>
                        </h3>
                        <a class="mt-25 read-more-btn" href="blog-details.html">Read More <i
